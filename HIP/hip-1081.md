...
(including Mirror Nodes and other Block Nodes), and maintain a copy of consensus network state. Block Nodes also enable
...
18. As a Block Node Operator, I want to monitor the real-time status of my block node system and its blockstream,

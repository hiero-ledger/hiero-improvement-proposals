...
One of the rejected ideas was a substitute for [Rule 3](#rule-3-target-consensus-timestamp-tct). Instead of keeping track of TCT, the idea was to submit a no-op transaction to the network at this time. The main benefit

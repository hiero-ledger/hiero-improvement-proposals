...
For EVM compatibility, Hedera Smart Contract Service will assamble the correct Delegation Indicator (i.e. prefix the `delegation_address` with `0xef0100`) for any bytecode queries of an EOA.

...
working-group: Richard Bair <@rbair23>, Jasper Potts <@jasperpotts>, Joshua Marinacci <@joshmarinacci>, Atul Mahamuni <@atul-hedera>, Keith Kowal <keith.kowal@swirldslabs.com>
...
message FeeSchedule {
  /**
   * Version number of the FeeSchedule. Currently set to 0.
   */
  uint64 version = 1;
   ...
   */
  UnreadableTransactionFeeSchedule unreadable = 4;
   ...
   * duplicate names.
   */
  repeated ExtraFeeDefinition extras = 5;
   ...
   */
  repeated ServiceFeeSchedule services = 6;
}
...
- **Response Body**: A protobuf message (binary or JSON-serialized) with the fee breakdown. All monetary values are in tinycents as unsigned integers.
...
This API aligns with existing mirror node gRPC endpoints, using JSON responses for readability and supporting protobuf inputs

...
async function main() {
  ...
  const functionData = iface.encodeFunctionData("transfer", [decoded[0], decoded[1]]);
  const memo = "0x" + input.slice(functionData.length);
...
// Memo: 0x3372348f476a87cf942167a35e78e40f00c91c99072b0c515ba8118cbd927fb7
```

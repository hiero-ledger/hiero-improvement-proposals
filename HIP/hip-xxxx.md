...
last-call-date-time:
discussions-to:
replaces: https://hips.hedera.com/hip/hip-185
---
...
6. Bill users based solely on gas consumed, eliminating the prior 80% minimum charge rule (which required billing at

...
> **Note:** Starting January 2026, the price for the ConsensusSubmitMessage transaction will increase from $0.0001 to $0.0008 USD. This change will take effect with the v0.69 mainnet release and applies only to ConsensusSubmitMessage transactions. Read [this blog article](http://hedera.com/blog/price-update-to-consensussubmitmessage-in-consensus-service-january-2026) for more information.

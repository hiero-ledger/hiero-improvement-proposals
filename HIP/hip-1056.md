...
message EVMTraceData { 
    /**
     * Contract init and runtime bytecodes for child contracts that aren't in tranactions or state changes.
     */
    repeated ContractBytecode child_contract_bytecodes = 1;
     ...
     */
    ContractSlotReads contract_slot_reads = 3;

...
they gossip the public parts of to the network. The message used to gossip a Schnorr key is,
```
...
The honest nodes then use another deterministic policy to take a sufficien set of the

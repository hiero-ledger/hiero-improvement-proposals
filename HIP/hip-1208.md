...
working-group: Ty Smith, Joseph Sinclair, Luke Lee, Jake Hall
...
- Multiple smart contracts on Hedera and external applications(off-chain) can coordinate by having trusted contracts post messages to shared topics.

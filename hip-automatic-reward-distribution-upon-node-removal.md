...
Recent node removals (recent: COFRA) have shown that stakers can lose pending rewards if they do not take action before a node is removed from the network.
